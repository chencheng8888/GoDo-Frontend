			...
			<div className="flex justify-between items-center mb-8">
				...
				<div className="flex space-x-2">
					...
					<div className="relative">
						...
						<Button isLoading={uploading} onClick={() => document.getElementById('file-upload')?.click()}>
					...
					<div className="grid grid-cols-1 divide-y divide-slate-100">
						{files.map((file, idx) => (
							<div key={idx} className="p-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
								...
								{/* <Button variant="ghost" className="text-slate-400 hover:text-red-600" onClick={() => handleDelete(file)}>
									<Trash2 size={18} />
								</Button> */}
								<CustomModal
									title="Are you sure you want to delete this file?"
									trigger={
										<Button variant="ghost" className="text-slate-400 hover:text-red-600">
											<Trash2 size={18} />
										</Button>
									}
									okText="Yes"
